...
Kirki::add_field( 'front_page_builder', array(
	...
	'label'		 => esc_attr__( 'Services Layout', 'front-page-builder' ),
	'section'	 => 'services_section',
	'default'	 => 'services-layout2',
	'priority'	 => 10,
	'choices'	 => array(
		'services-layout1'	 => FPB_SAMPLE_PLUGIN_URL . 'img/services/service-layout1.jpg',
		'services-layout2'	 => FPB_SAMPLE_PLUGIN_URL . 'img/services/service-layout2.jpg',
		'services-layout3'	 => FPB_SAMPLE_PLUGIN_URL . 'img/services/service-layout3.jpg',
		'services-layout4'	 => FPB_SAMPLE_PLUGIN_URL . 'img/services/service-layout4.jpg',
	),
) );
Kirki::add_field( 'front_page_builder', array(
	'type'				 => 'color',
	'settings'			 => 'services_layout_icon_color',
	'label'				 => esc_attr__( 'Section Icon Border Color', 'front-page-builder' ),
	'section'			 => 'services_section',
	'default'			 => '#e61e65',
	'priority'			 => 10,
	'transport'			 => 'auto',
	'output'			 => array(
		array(
			'element'	 => '.services-layout2 .services-icon:after, .services-layout2 .services-icon:before',
...
Kirki::add_field( 'front_page_builder', array(
	'type'		 => 'typography',
	'settings'	 => 'service_title_font',
	'transport'	 => 'auto',
	'label'		 => esc_attr__( 'Service Title Font', 'front-page-builder' ),
	'section'	 => 'services_section',
	'transport'	 => 'auto',
	'default'	 => array(
	...
	'output'	 => array(
		array(
			'element' => 'h2.services-title',
		),
	),
) );
Kirki::add_field( 'front_page_builder', array(
	'type'		 => 'typography',
	'settings'	 => 'service_description_font',
	'transport'	 => 'auto',
	'label'		 => esc_attr__( 'Service Description Font', 'front-page-builder' ),
	'section'	 => 'services_section',
	'transport'	 => 'auto',
	'default'	 => array(
		'font-family'	 => 'Roboto Condensed',
...
Kirki::add_field( 'front_page_builder', array(
	...
	'priority'	 => 10,
	'choices'	 => array(
		'text'		 => esc_attr__( 'Service Icon Color', 'front-page-builder' ),
		'hover'		 => esc_attr__( 'Service Text Hover', 'front-page-builder' ),
		'bg'		 => esc_attr__( 'Service Background', 'front-page-builder' ),
		'bg-hover'	 => esc_attr__( 'Service Background Hover', 'front-page-builder' ),
	),
	'default'	 => array(
		'text'		 => '#000000',
		'hover'		 => '#ffffff',
	...
	'output'	 => array(
		...
		array(
			'choice'	 => 'text',
			'element'	 => '.services-inner-block, .services-icon',
			'property'	 => 'border-color',
		),
		array(
			'choice'	 => 'hover',
			'element'	 => '.services-inner-block:hover .services-icon, .services-layout2 .services-inner-block:hover .services-icon:after, .services-layout2 .services-inner-block:hover .services-icon:before',
			'property'	 => 'border-color',
		),
		array(
			'choice'	 => 'hover',
			'element'	 => '.services-inner-block:hover, .services-inner-block:hover .services-icon, .services-inner-block:hover .services-desc, .services-inner-block:hover h2.services-title',
			'property'	 => 'color',
		),
		array(
			'choice'	 => 'bg',
			'element'	 => '.services-inner-block',
			'property'	 => 'background-color',
		),
		array(
			'choice'	 => 'bg',
			'element'	 => '.services-layout2 .services-inner-block:before, .services-layout1 .services-icon',
			'property'	 => 'border-color',
		),
		array(
			'choice'	 => 'bg-hover',
			'element'	 => '.services-inner-block:hover',
			'property'	 => 'background-color',
		),
		array(
			'choice'	 => 'bg-hover',
			'element'	 => '.services-layout2 .services-inner-block:hover:before',
			'property'	 => 'border-color',
		),
	),
) );
Kirki::add_field( 'front_page_builder', array(
	...
	'settings'			 => 'services_border',
	'label'				 => esc_attr__( 'Corners', 'front-page-builder' ),
	'section'			 => 'services_section',
	'default'			 => '0px',
	'priority'			 => 10,
	'transport'			 => 'auto',
	'choices'			 => array(
		'8px'	 => esc_attr__( 'Rounded', 'front-page-builder' ),
		'0px'	 => esc_attr__( 'Squared', 'front-page-builder' ),
	),
	'output'			 => array(
		array(
			'element'	 => '.services-inner-block',
...
Kirki::add_field( 'front_page_builder', array(
	'type'		 => 'radio-buttonset',
	'settings'	 => 'services_section_row',
	'label'		 => esc_attr__( 'Colums In Row', 'front-page-builder' ),
	'section'	 => 'services_section',
	'default'	 => 'col-md-4',
	'priority'	 => 10,
	'choices'	 => array(
...
Kirki::add_field( 'front_page_builder', array(
	'type'		 => 'repeater',
	'label'		 => esc_attr__( 'Services', 'front-page-builder' ),
	'section'	 => 'services_section',
	'priority'	 => 10,
	...
	'fields'	 => array(
		'services_icon'	 => array(
			'type'		 => 'select',
			'label'		 => esc_attr__( 'Icon', 'front-page-builder' ),
			'default'	 => '',
			'choices'	 => fpb_font_awesome_icon_array(),
		),
	...
	'row_label'	 => array(
		'type'	 => 'text',
		'value'	 => esc_attr__( 'Service', 'front-page-builder' ),
	),
) );

function fpb_font_awesome_icon_array() {
